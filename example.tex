...
\hypersetup{%
pdftitle={Hey look! I changed the title!}, % full title here
pdfauthor={Louis Zucaro, Also Louis Zucaro, Third Louis Zucaro, and Can you believe it? It's Louis Zucaro!}, % full author list here
}
...
% AUTHORS EDIT THIS PART
\title{Hey look! I changed the title!}
\author{Louis Zucaro}
\altaffiliation{Manalapan High School} % use for non S&E authors
\author{Also Louis Zucaro}
\author{Third Louis Zucaro}
\author{Can you believe it? It's Louis Zucaro!}
\email[Contact author: ]{428lzucaro@frhsd.com} % use FRHSD address
% For S&E authors
